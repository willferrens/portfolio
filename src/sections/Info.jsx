        ...
        <div className="container mx-auto max-w-6xl">
            ...
            >
                ...
                <motion.div 
                    ...
                    viewport={{ once: true }} className="min-w-xl mx-auto grid grid-row lg:grid-cols-2 gap-8"
                >
                    <div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-[repeat(auto-fit,_minmax(75px,_1fr))] gap-8 justify-items-center text-gray-700">
                            {
                                info.skills.map((skill, idx) => (
                                    ...
                                    >
                                        <img 
                                            loading="lazy" alt={`${skill.title}`} className="w-12 h-12" 
                        ...
                        <div className="text-white text-sm">
                            {
                                info.socials.map((social, idx) => (
                                    <button
                                        ...
                                        className={`hover:opacity-90 rounded-lg shadow-md px-5 py-3 inline-flex items-center mr-2 gap-2 transition-colors`}
                                    >
