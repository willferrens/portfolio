...
const Hero = forwardRef((props, ref) => (
    <section ref={ref} className="relative h-screen md:h-[70vh] flex items-center justify-center  bg-black">
        ...
        >
            <motion.h1
                ...
                viewport={{ once: true }} className="text-3xl md:text-4xl  font-bold"
            >
                Welcome! I'm Will Ferrens
            </motion.h1>
            <motion.p
                initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.2 }}
                viewport={{ once: true }} className="mt-4 px-4 md:px-0 text-xl md:text-2xl text-white max-w-3xl"
            >
